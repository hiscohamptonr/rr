-- SQL-only BSCR aggregation: peril 1 and policy type 1 in every region.
-- Preserves the legacy seven columns and appends the explicit peril ID.
-- Single-peril comparison variant; all region labels use earthquake exposure.
-- Even normally wind-routed regions use peril 1; this is not dual-peril output.
